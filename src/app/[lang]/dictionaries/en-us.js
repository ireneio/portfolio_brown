export default {
  ...
  "about": {
    "title": "About Me",
    "introduction": "Software Engineer with 4+ years of experience in Frontend Development, seeking full-time frontend development roles."
  },
  "hard_skills": {
    "title": "Hard Skills"
  },
  ...
  "experience": {
    ...
    "first": {
      ...
      "location": "Remote",
      "description": `
        <li>Led product refactor from MVC to MVVM, which improved user intention rate over 20%.</li>
        <li>Managed a team of approximately 5-7 individuals, provided technical guidance to juniors and assigned tasks to team members.</li>
        <li>Regularly hosted code reviews and project discussions to solidify team collaboration and improve code quality.</li>
      `,
    ...
    "second": {
      ...
      "location": "Remote",
      "description": `
        <li>Launched a Web3 integration dashboard from 0-1, which directly contributed to the launch of $CATHEON Token and the SolChicks P2E game.</li>
        <li>Lead a team of 5-7 with direct communication with the management team.</li>
      `,
    ...
    "third": {
      ...
      "description": `
        <li>Refactor of existing frontend codebase from MVC to ReactJS, improved user retention rate by 10%.</li>
        <li>Led a team of 4 responsible for building internal dashboards.</li>
        <li>Regularly host and involve with team code review events.</li>
      `,
    ...
    "fourth": {
      "title": "Linkedin",
      role: "Frontend Engineer",
      "location": "Silicon Valley, California, U.S.",
      "description": `
        <li>Participated in the development of the web application, improved UX and received positive feedbacks from user.</li>
        <li>Assisted in improving the TTL of web app by 10\% through refactoring.</li>
        <li>Discussions with PM and UI to improve the UI/UX of web app.</li>
        <li>Discussions with backend team for API specs.</li>
      `,
  ...
  "soft_skills": {
    title: "Soft SKills",
    technical_leadership: '2 years experience in team management',
    project_management: 'Project and timeline management',
    cross_functional_communication: 'Cross-functional communication',
  },
  "header": {
    "home": "Home",
    "about": "About Me",
